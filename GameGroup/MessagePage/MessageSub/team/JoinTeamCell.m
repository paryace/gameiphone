...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.groupNameLable = [[UILabel alloc]initWithFrame:CGRectMake(55, 12, 100, 20)];
        ...
        self.genderImageV = [[UIImageView alloc]initWithFrame:CGRectMake(160, 10, 20, 20)];
        [self.bgV addSubview:self.genderImageV];
        
        self.positionLable = [[UILabel alloc]initWithFrame:CGRectMake(185, 10, 50, 20)];
        ...
        self.gameImageV = [[EGOImageView alloc]initWithFrame:CGRectMake(55, 35, 25, 25)];
        [self.bgV addSubview:self.gameImageV];
        
        self.realmLable = [[UILabel alloc]initWithFrame:CGRectMake(85, 37, 200, 20)];
        ...
        self.pveLable = [[UILabel alloc]initWithFrame:CGRectMake(55, 62, 300, 20)];
        ...
        self.timeLable = [[UILabel alloc]initWithFrame:CGRectMake(200, 12, 100, 20)];
