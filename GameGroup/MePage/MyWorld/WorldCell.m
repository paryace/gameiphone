...
//        [self.contentView addGestureRecognizer:tapMIss];
        ...
        [self.openBtn setBackgroundImage:KUIImage(@"zan_pl_normall") forState:UIControlStateNormal];
...
//        self.menuImageView.image = KUIImage(@"bgImg");
        ...
        [self.commentBtn setBackgroundImage:KUIImage(@"pinglun2_03") forState:UIControlStateHighlighted];
