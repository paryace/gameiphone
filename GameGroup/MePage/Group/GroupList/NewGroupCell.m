...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 10, 320-100-35-2-60, 20)];
        ...
        self.numberLable = [[UILabel alloc] initWithFrame:CGRectMake(80, 33, 50, 10)];
        ...
        self.cricleLable= [[UILabel alloc] initWithFrame:CGRectMake(60, 45, 320-100-60-5, 20)];
