...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.headImageV = [[EGOImageView alloc] initWithFrame:CGRectMake(10, 12, 50, 50)];
        self.headImageV.backgroundColor = [UIColor whiteColor];
        self.headImageV.layer.cornerRadius = 5;
        self.headImageV.layer.masksToBounds=YES;
        [self addSubview:self.headImageV];
        
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(65, 10, 320-80-35-2-65, 20)];
        [self.nameLabel setTextAlignment:NSTextAlignmentLeft];
        [self.nameLabel setFont:[UIFont boldSystemFontOfSize:14.0]];
        [self.nameLabel setBackgroundColor:[UIColor clearColor]];
        [self addSubview:self.nameLabel];
        
        self.gameImageV = [[EGOImageView alloc] initWithFrame:CGRectMake(65, 32, 13, 13)];
        [self addSubview:self.gameImageV];
        
        self.numberLable = [[UILabel alloc] initWithFrame:CGRectMake(85, 34, 50, 10)];
        ...
        self.cricleLable = [[UILabel alloc] initWithFrame:CGRectMake(65, 45, 320-80-60-10, 20)];
        [self.cricleLable setTextAlignment:NSTextAlignmentLeft];
        [self.cricleLable setFont:[UIFont boldSystemFontOfSize:10.0]];
        ...
        UIView * lineView = [[UIView alloc] initWithFrame:CGRectMake(10, 74, 320-80-10, 0.5)];
        lineView.backgroundColor = kColorWithRGB(220, 220, 223,1);
