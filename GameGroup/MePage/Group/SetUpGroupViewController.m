...
- (void)viewDidLoad
{
    ...
    [shareButton setBackgroundImage:KUIImage(@"okButton") forState:UIControlStateNormal];
    [shareButton setBackgroundImage:KUIImage(@"okButton2") forState:UIControlStateHighlighted];
