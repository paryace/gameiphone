...
- (void)viewDidLoad
{
    ...
    [chooseAllBtn setBackgroundImage:KUIImage(@"choose_all") forState:UIControlStateNormal];
    [chooseAllBtn setBackgroundImage:KUIImage(@"choose_all") forState:UIControlStateHighlighted];
